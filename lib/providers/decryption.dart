...
Future<String> doDecryption(DoDecryptionRef ref, String? realPath) async {
  ...
  final tvSize = int.parse(String.fromCharCodes(bytes.getRange(firstEqualSignOfHtmlTagPosition + 1, firstSpaceOrCloseMarkOfHtmlTagPosition)));
...
<TrustView>
    ...
    logger.i('keyHex: $keyHex');

    // 解密文件体
    final fileBodyStartAt = tvSize + 36 + 5216;
    var fileBodyEndAt = bytes.length - 1;
    ...
    final bodyDecryptor = Decryptor(
      Uint8List.fromList(decryptor.hexToBytes(keyHex)), // 处理一下keyHex
